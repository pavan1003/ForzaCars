  ...
  <div class="container-fluid m-0 pb-5">
    ...
    <div class="container">
      ...
      <div class="container mt-5">
        <h2>Confirm Deletion of Car</h2>
        <p>Are you sure you want to delete the following car?</p>
        <p><strong>Name and Model:</strong> <?php echo $result['Name_and_model']; ?></p>
        <p><strong>Type:</strong> <?php echo $result['Model_type']; ?></p>
        <p><strong>In Game Price:</strong> <?php echo $result['In_Game_Price']; ?></p>
        <p><strong>HP:</strong> <?php echo $result['Horse_Power']; ?></p>
