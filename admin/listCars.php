...
<body>
  ...
  <div class="container-fluid custom-bg">
    <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="display-4 my-3 bg-light rounded-5 text-center">List of all Forza Horizon 5 Cars</h1>
        </div>
      </div>
    </div>
    <div class="container">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-4">
                      ...
                      <form action="updateCar.php" method="GET">
                        <input type="hidden" name="id" value="<?php echo $car['id']; ?>">
                        <button type="submit" class="btn btn-sm btn-primary" name="updateCar">
                          Update
                        </button>
                      </form>
                    </div>
